          ...
          <div class="card shadow-md rounded-md mt-5">
            ...
            <div class="card-body">
              ...
              <form action="/authenticate" method="post">
                ...
                <div class="form-group">
                  <Label>Senha</Label>
                  <input type="password" class="form-control py-4" name="password" placeholder="Digite sua senha" required>
                </div>

                <div class="form-group d-flex justify-content-center mt-4 mb-0">
                  <button type="submit" class="btn btn-primary">Entrar</button>
                  <a href="/home" type="button" class="btn btn-secondary ml-1">Cancelar</a>
                </div>
